...
const InstancesList = () => {
  ...
  const recentInstances = useMemo(() => {
    return [...instances].sort((a, b) => b.id - a.id);
  }, [instances]);

  const [filteredInstances, setFilteredInstances] = useState(recentInstances);
  ...
  useEffect(() => {
    setFilteredInstances(recentInstances);
  }, [recentInstances]);
      ...
      <div className="row align-items-center mb-4">
        <div className="col-md-8">
          ...
          <p className="text-muted small mb-0">
            {recentInstances.length} instancia
            {recentInstances.length !== 1 ? "s" : ""} encontrada
            {recentInstances.length !== 1 ? "s" : ""}
          </p>
        </div>
      ...
      {filteredInstances.length === 0 ? (
        ...
        <div className="row g-4">
          {filteredInstances.map((instance) => (
            <div className="col-12 col-lg-6 col-xl-4" key={instance.id}>
              <div className="card h-100 shadow-sm border-0 rounded-3">
                <div className="card-header bg-white border-bottom py-3 px-3">
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <span
                      className={`badge ${getStatusColor(instance.state)} text-uppercase`}
                  ...
                  <div className="row g-3 mb-3">
                        ...
                        <div>
                          ...
                          {instance.closure_date && (
                            <>
                              ...
                              <div className="fw-semibold small">
                                {formatDate(instance.closure_date)}
                              </div>
                            </>
                          )}
                        </div>
                    ...
                    <div className="col-6">
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <div className="text-muted small">Participantes</div>
